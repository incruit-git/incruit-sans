...
- 2026-07-05 (v0.4): 한글↔라틴 경계 class kern 추가 — 시각 간격 실측(한→한 146·라→라 209·한→라 192·라→한 163) 후 A/B/C 렌더 판정으로 +45/+75 채택. hb-shape로 발동(년A 1770→1815)·기존 라틴 kern(To -158)·chws 보존 확인.
